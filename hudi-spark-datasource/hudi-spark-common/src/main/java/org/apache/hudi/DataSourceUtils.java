...
public class DataSourceUtils {
  ...
  public static HiveSyncConfig buildHiveSyncConfig(TypedProperties props, String basePath, String baseFileFormat) {
    ...
    hiveSyncConfig.useKerberos = Boolean.valueOf(props.getString(DataSourceWriteOptions.HIVE_SYNC_USE_KERBEROS().key(),
        DataSourceWriteOptions.HIVE_SYNC_USE_KERBEROS().defaultValue()));
    hiveSyncConfig.kerberosPrincipal = props.getString(DataSourceWriteOptions.HIVE_SYNC_KERBEROS_PRINCIPAL().key(),
